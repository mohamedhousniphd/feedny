...
async def submit_feedback(
    ...
    # Insert feedback
    feedback_id = insert_feedback(request.content, device_id)
...
async def analyze_feedbacks_endpoint(request_data: AnalyzeRequest, request: Request):
    ...
    wordcloud_image, word_frequencies = create_wordcloud(feedbacks_text)

    # Generate AI summary
    summary = await analyze_feedbacks(
        feedbacks=[fb["content"] for fb in feedbacks],
