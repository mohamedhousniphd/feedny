...
def test_db(tmp_path, monkeypatch):
    ...
    # Pre-emptively set the DATABASE_URL to our temporary file
    ...
    # Cleanup is handled by tmp_path and monkeypatch teardown
...
def test_get_feedbacks_by_ids():
    ...
    assert database.get_feedbacks_by_ids(None) == []
